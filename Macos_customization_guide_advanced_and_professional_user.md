...
| **API Testing**          | **Postman** / **Insomnia**/**Bruno**: Essential tools for developing and testing APIs.                                                                                                                                                                                                    |
...
| **Office & Productivity**| **LibreOffice**: A complete, open-source office suite. **OnlyOffice**: very stable and MS looking like but less features compared to LibreOffice, but offers other features.**Obsidian** / **Joplin**: Powerful, Markdown-based note-taking apps. **Draw io**. **Table plus**. **YTDownloader**. **video downloader**. **LocalSend**. **Anydesk**                                                                                                                                              |
